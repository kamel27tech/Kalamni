          ...
          <View style={s.top}>
            <View style={s.header}>
              ...
              <View style={s.headerText}>
                ...
                <Text style={s.subtitle}>
                  Fill the following information to start your Arabic learning journey!
                </Text>
              </View>
            </View>
            ...
            <View style={s.form}>
              ...
              <View style={s.cta}>
                ...
                <Text style={s.terms}>
                  {`By clicking “`}
                  <Text style={s.termsLink}>Register</Text>
                  {`” you agree to our `}
                  <Text style={s.termsLink}>terms of use & privacy policy</Text>
                </Text>
                {displayError != null && (
